...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCoordsOfAngle", function() { return getCoordsOfAngle; });
...
const getCoordsOfAngle = (cx, cy, radius, angle) => {
...
/***/ "./source/js/modules/canvas/common/time-functions.js":
/*!***********************************************************!*\
  !*** ./source/js/modules/canvas/common/time-functions.js ***!
  \***********************************************************/
/*! exports provided: power, back, bounce, elastic, circ, makeEaseOut, makeEaseInOut */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makeEaseInOut", function() { return makeEaseInOut; });
const power = (n, timeFraction) => {
  return Math.pow(timeFraction, n);
};

const back = (x, timeFraction) => Math.pow(timeFraction, 2) * ((x + 1) * timeFraction - x);
...
/***/ "./source/js/modules/canvas/fail/confetti.js":
/*!***************************************************!*\
  !*** ./source/js/modules/canvas/fail/confetti.js ***!
  \***************************************************/
/*! exports provided: default */
...
/* harmony import */ var _common_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../common/helpers */ "./source/js/modules/canvas/common/helpers.js");
/* harmony import */ var _common_time_functions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../common/time-functions */ "./source/js/modules/canvas/common/time-functions.js");
...
class Confetti {
  constructor({duration, ctx}) {
    ...
    this.confettiEasingFn = (timingFraction) => Object(_common_time_functions__WEBPACK_IMPORTED_MODULE_1__["power"])(2, timingFraction);
  ...
  scaleAnimationTick(from, to) {
    return (progress) => {
      this.scale = Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from, to, progress);
    };
  }

  opacityAnimationTick(from, to) {
    return (progress) => {
      this.opacity = Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from, to, progress);
    };
  }

  confettiPositionAnimationTick(image, from, to) {
    return (progress) => {
      this.confetti[image].position.left = Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from.left, to.left, progress);
      this.confetti[image].position.top = Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from.top, to.top, progress);
    };
  }

  confettiSkewAnimationTick(image, from, to) {
    return (progress) => {
      this.confetti[image].skew[0] = Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from[0], to[0], progress);
      this.confetti[image].skew[1] = Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from[1], to[1], progress);
    };
  }

  animate() {
    Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.scaleAnimationTick(this.initialScale, this.finalScale), this.duration * 0.3);
    Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.opacityAnimationTick(0, 1), this.duration * 0.2);
    Object.keys(this.confetti).map((image) => {
      Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.confettiPositionAnimationTick(image, this.confetti[image].initialPosition, this.confetti[image].middlePosition), this.duration * 0.5);
      Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.confettiSkewAnimationTick(image, this.confetti[image].initialSkew, this.confetti[image].finalSkew), this.duration * 0.5);
    });
    Object.keys(this.confetti).map((image) => {
      setTimeout(() => {
        Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["animateEasing"])(this.confettiPositionAnimationTick(image, this.confetti[image].middlePosition, this.confetti[image].finalPosition), this.duration * 0.4, this.confettiEasingFn);
      }, this.duration * 0.9);
    });
  }
  ...
  drawConfettiPart(image) {
    ...
    Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["skewCtx"])(this.ctx, ...this.confetti[image].skew);
...
/***/ "./source/js/modules/canvas/fail/index.js":
/*!************************************************!*\
  !*** ./source/js/modules/canvas/fail/index.js ***!
  \************************************************/
/*! exports provided: endAnimation, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "endAnimation", function() { return endAnimation; });
/* harmony import */ var _main__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./main */ "./source/js/modules/canvas/fail/main.js");
/* harmony import */ var _confetti__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./confetti */ "./source/js/modules/canvas/fail/confetti.js");
/* harmony import */ var _tear__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./tear */ "./source/js/modules/canvas/fail/tear.js");
/* harmony import */ var _common_helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../common/helpers */ "./source/js/modules/canvas/common/helpers.js");
...
const drawDuration = async () => {
  ...
  const main = new _main__WEBPACK_IMPORTED_MODULE_0__["default"]({duration: ANIMATION_DURATION, ctx});
  main.prepareImage();

  const confetti = new _confetti__WEBPACK_IMPORTED_MODULE_1__["default"]({duration: ANIMATION_DURATION * 0.9, ctx});
  ...
  Object(_common_helpers__WEBPACK_IMPORTED_MODULE_3__["animateDuration"])(render, TOTAL_DURATION);
};
...
const drawInfinite = async () => {
  ...
  const tear = new _tear__WEBPACK_IMPORTED_MODULE_2__["default"]({duration: ANIMATION_DURATION * 2, ctx});
  tear.prepareImage();
...
/***/ "./source/js/modules/canvas/fail/main.js":
/*!***********************************************!*\
  !*** ./source/js/modules/canvas/fail/main.js ***!
  \***********************************************/
/*! exports provided: default */
...
class Main {
  ...
  crocodilePositionAnimationTick(from, to) {
    return (progress) => {
      this.crocodilePosition.left = Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from.left, to.left, progress);
      this.crocodilePosition.top = Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from.top, to.top, progress);
    };
  }

  keyholeProgressAnimationTick(from, to) {
    return (progress) => {
      this.keyhole.progress = Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from, to, progress);
    };
  }

  animate() {
    Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.opacityAnimationTick(0, 1), this.duration * 0.2);
    Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.keyholeProgressAnimationTick(this.initialKeyhole.progress, this.finalKeyhole.progress), this.duration * 0.2);
    setTimeout(() => {
      Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.crocodilePositionAnimationTick(this.initialCrocodilePosition, this.finalCrocodilePosition), this.duration * 0.7);
    }, this.duration * 0.3);
  }
  ...
  setCoordsOfKeyhole() {
    ...
    this.triangleLeftTopPoint = Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["getCoordsOfAngle"])(this.keyholeArcCenter.x, this.keyholeArcCenter.y, this.arcRadius, this.arcAngles.end);
    ...
    this.triangleRightTopPoint = Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["getCoordsOfAngle"])(this.keyholeArcCenter.x, this.keyholeArcCenter.y, this.arcRadius, this.arcAngles.start);
...
/***/ "./source/js/modules/canvas/fail/tear.js":
/*!***********************************************!*\
  !*** ./source/js/modules/canvas/fail/tear.js ***!
  \***********************************************/
/*! exports provided: default */
...
class Tear {
  constructor({duration, ctx}) {
    ...
    this.back = (timeFraction) => Object(_common_time_functions__WEBPACK_IMPORTED_MODULE_1__["back"])(0.2, timeFraction);
  ...
  positionAnimationTick(from, to) {
    return (progress) => {
      this.position.top = Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from.top, to.top, progress);
    };
  }
  ...
  scaleAnimationTick(from, to, distort) {
    return (progress) => {
      this.scale[0] = Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from[0], to[0], distort ? Math.pow(progress, 0.2) : progress);
      this.scale[1] = Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from[1], to[1], distort ? Math.pow(progress, 0.7) : progress);
    };
  }
  ...
  animate() {
    ...
    Promise.all([
      Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["animateEasing"])(this.positionAnimationTick(this.initialPosition, this.finalPosition), this.duration, this.back),
      Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.scaleAnimationTick(this.initalScale, this.middleScale, true), this.duration * 0.4),

      new Promise((resolve) => {
        new Promise((resolveTimeout) => setTimeout(resolveTimeout, this.duration * 0.8)).then(() => {
          Promise.all([
            Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.opacityAnimationTick(this.middleOpacity, this.finalOpacity), this.duration * 0.2),
            Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.scaleAnimationTick(this.middleScale, this.finalScale, false), this.duration * 0.2),
          ]).then(resolve);
        });
      }),
    ]).then(() => {
...
/***/ "./source/js/modules/canvas/trip/index.js":
/*!************************************************!*\
  !*** ./source/js/modules/canvas/trip/index.js ***!
  \************************************************/
/*! exports provided: endAnimation, default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "endAnimation", function() { return endAnimation; });
/* harmony import */ var _plane__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./plane */ "./source/js/modules/canvas/trip/plane.js");
/* harmony import */ var _walrus__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./walrus */ "./source/js/modules/canvas/trip/walrus.js");
/* harmony import */ var _snowflake__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./snowflake */ "./source/js/modules/canvas/trip/snowflake.js");
/* harmony import */ var _common_helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../common/helpers */ "./source/js/modules/canvas/common/helpers.js");
...
const drawDuration = async () => {
  ...
  const walrus = new _walrus__WEBPACK_IMPORTED_MODULE_1__["default"]({duration: ANIMATION_DURATION, ctx});
  walrus.prepareImage();
...
/***/ "./source/js/modules/canvas/trip/plane.js":
/*!************************************************!*\
  !*** ./source/js/modules/canvas/trip/plane.js ***!
  \************************************************/
/*! exports provided: default */
...
class Plane {
  ...
  getPlaneTail() {
    ...
    return Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["rotateCoords"])(center.x, center.y, zeroDegreeCoords.x, zeroDegreeCoords.y, this.planePosition.angle);
  }
  ...
  planePositionAnimationTick(from, to) {
    return (progress) => {
      this.planePosition.left = Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from.left, to.left, progress);
  ...
  planeRotateAnimationTick(from, to) {
    return (progress) => {
      this.planePosition.angle = Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from, to, Math.pow(progress, 2.5));
    };
  }
  ...
  backgroundAnimationTick(from, to) {
    return (progress) => {
      ...
      this.background.size = Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from, to, progress);
    };
  }

  growingTreePositionTick(from, to) {
    return (progress) => {
      this.growingTree.offset = Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from, to, progress);
    };
  }

  animate() {
    Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.opacityAnimationTick(0, 1), this.duration);
    Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.planePositionAnimationTick(this.initialPlanePosition, this.finalPlanePosition), this.duration);
    Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.planeRotateAnimationTick(this.initialPlanePosition.angle, this.finalPlanePosition.angle), this.duration);
    Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.backgroundAnimationTick(this.initialBackground.size, this.finalBackground.size), this.duration);
    Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.growingTreePositionTick(this.growingTreeInitialOffset, this.growingTreeFinalOffset), this.duration);
  }

  drawPlane() {
    this.ctx.save();
    const {x, y} = this.getPlaneCenter();
    Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["rotateCtx"])(this.ctx, this.planePosition.angle, x, y);
...
/***/ "./source/js/modules/canvas/trip/snowflake.js":
/*!****************************************************!*\
  !*** ./source/js/modules/canvas/trip/snowflake.js ***!
  \****************************************************/
/*! exports provided: default */
...
class Snowflake {
  ...
  draw() {
    ...
    Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["skewCtx"])(this.ctx, ...this.skew);
    this.ctx.scale(...this.scale);
    this.ctx.globalAlpha = this.opacity;
...
/***/ "./source/js/modules/canvas/trip/walrus.js":
/*!*************************************************!*\
  !*** ./source/js/modules/canvas/trip/walrus.js ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Walrus; });
/* harmony import */ var _common_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../common/helpers */ "./source/js/modules/canvas/common/helpers.js");
/* harmony import */ var _common_time_functions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../common/time-functions */ "./source/js/modules/canvas/common/time-functions.js");
...
class Walrus {
  ...
  translateYAnimationTick(from, to) {
    return (progress) => {
      this.translateY = Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from, to, progress);
    };
  }

  rotateAnimationTick(from, to) {
    return (progress) => {
      this.angle = Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from, to, progress);
    };
  }

  animate() {
    Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.translateYAnimationTick(this.initialPosition.top, this.finalPosition.top), this.duration);
    setTimeout(() => {
      Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["animateEasing"])(this.rotateAnimationTick(30, 0), this.duration * 0.6, Object(_common_time_functions__WEBPACK_IMPORTED_MODULE_1__["makeEaseOut"])(_common_time_functions__WEBPACK_IMPORTED_MODULE_1__["bounce"]));
    }, this.duration * 0.4);
  }
  ...
  draw() {
    ...
    Object(_common_helpers__WEBPACK_IMPORTED_MODULE_0__["rotateCtx"])(this.ctx, this.angle, x, y);
...
/***/ "./source/js/modules/countdown/animate-game-countdown.js":
/*!***************************************************************!*\
  !*** ./source/js/modules/countdown/animate-game-countdown.js ***!
  \***************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (gameCountdown);


/***/ }),

/***/ "./source/js/modules/countdown/animate-prize-amount.js":
/*!*************************************************************!*\
  !*** ./source/js/modules/countdown/animate-prize-amount.js ***!
  \*************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (PrizeAmountCountdown);


/***/ }),

/***/ "./source/js/modules/document.js":
/*!***************************************!*\
  !*** ./source/js/modules/document.js ***!
  \***************************************/
/*! exports provided: default */
...
/* harmony import */ var _modules_countdown_animate_game_countdown__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../modules/countdown/animate-game-countdown */ "./source/js/modules/countdown/animate-game-countdown.js");
/* harmony import */ var _modules_countdown_animate_prize_amount__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modules/countdown/animate-prize-amount */ "./source/js/modules/countdown/animate-prize-amount.js");
...
class FullPageScroll {
  ...
  changeVisibilityDisplay() {
    ...
    if (isGame) {
      _modules_countdown_animate_game_countdown__WEBPACK_IMPORTED_MODULE_1__["default"].startCountdown();
    }

    if (!isGame) {
      _modules_countdown_animate_game_countdown__WEBPACK_IMPORTED_MODULE_1__["default"].endCountdown();
    }
  }
  ...
  animatePrize({prize, timeout, firstAmount}) {
    ...
    const amountCoundown = new _modules_countdown_animate_prize_amount__WEBPACK_IMPORTED_MODULE_2__["default"]({element: amountElement, amount, firstAmount});
...
const addIntroTitleAnimation = () => {
  ...
  const animation = new _letter_animation__WEBPACK_IMPORTED_MODULE_0__["default"]({
    element,
    duration: 400,
...
/* harmony default export */ __webpack_exports__["default"] = (LetterAnimation);
...
/***/ "./source/js/modules/svg/animate-result.js":
/*!*************************************************!*\
  !*** ./source/js/modules/svg/animate-result.js ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_canvas_trip__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../modules/canvas/trip */ "./source/js/modules/canvas/trip/index.js");
/* harmony import */ var _modules_canvas_fail__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../modules/canvas/fail */ "./source/js/modules/canvas/fail/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  startAnimationByClick({
    ...
    callback: _modules_canvas_trip__WEBPACK_IMPORTED_MODULE_0__["default"],
  });
  ...
  startAnimationByClick({
    ...
    callback: _modules_canvas_fail__WEBPACK_IMPORTED_MODULE_1__["default"],
  });
});
...
/* harmony import */ var _modules_document__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/document */ "./source/js/modules/document.js");
...
/* harmony import */ var _modules_intro__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/intro */ "./source/js/modules/intro.js");
/* harmony import */ var _modules_svg_animate_result__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/svg/animate-result */ "./source/js/modules/svg/animate-result.js");
// modules
...
Object(_modules_document__WEBPACK_IMPORTED_MODULE_9__["default"])();
Object(_modules_rules__WEBPACK_IMPORTED_MODULE_10__["default"])();
Object(_modules_intro__WEBPACK_IMPORTED_MODULE_11__["default"])();
Object(_modules_svg_animate_result__WEBPACK_IMPORTED_MODULE_12__["default"])();
